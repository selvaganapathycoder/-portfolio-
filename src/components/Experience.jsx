...
const Experience = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Reveal cards with a staggered "float up" effect
      ...
      <div className="container relative z-10 px-6 mx-auto max-w-7xl">
        <div className="exp-header mb-16 md:mb-24 text-center md:text-left">
          ...
          <h2 className="text-5xl md:text-7xl font-serif font-light mb-6 tracking-tight">
            Key{" "}
            <span className="italic font-normal text-white">Experience</span>
          </h2>
          <p className="max-w-2xl text-lg md:text-xl text-white/50 leading-relaxed font-light">
            My contributions to high-scale open source projects and building
            production-ready features that focus on performance and
            maintainability.
          </p>
        </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="p-4 rounded-xl bg-white/[0.03] border border-white/5 mb-6">
                    <div className="flex items-center gap-2 mb-3 text-xs font-bold uppercase tracking-wider text-white/60">
                      <FiCheckCircle className="text-green-500" /> Impact
                    </div>
                ...
                <div className="pt-8 mt-auto border-t border-white/5">
                  ...
                  {item.pr && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="w-full py-4 rounded-xl flex items-center justify-center gap-2 text-sm font-bold transition-all duration-300 relative overflow-hidden group/btn"
                    >
                      <span className="absolute inset-0 bg-white opacity-[0.03] group-hover/btn:opacity-[0.08] transition-opacity"></span>
                      <FiCode className="group-hover/btn:scale-110 transition-transform" />
                      View Pull Request
                      <FiExternalLink className="text-[10px] opacity-0 group-hover/btn:opacity-100 group-hover/btn:translate-x-1 transition-all" />
                    </a>
                  )}
                </div>
              </div>
